...
class AssetManager_model extends CI_Model {
        ...
        public function get_assets() {
            ...
            $this->db->join('asset_types as at', 'a.type = at.id');
            $this->db->join('teams as t', 'a.team = t.id');
            $this->db->join('models as mo', 'a.model = mo.id');
            $this->db->join('manufacturers as ma', 'mo.manufacturer = ma.id');
            $query = $this->db->get();
