<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/DataTables/dataTables.css"/>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/DataTables/dataTables.js"></script>
